...
class mm_post_type_archive_link {
    ...
    public function load(){
        ...
        add_action('wp_ajax_mm-add-post-type-archive-links', array( __CLASS__, 'ajax_add_post_type'));
    ...
    public function add_meta_box() {
        ...
        add_meta_box( 'post-type-archives', __('Post Types','mm-post-type-archive-links'),array(__CLASS__,'metabox'),'nav-menus' ,'side','low');
    }
    ...
    public function metabox_script($hook) {
        ...
        wp_enqueue_script( 'mm-post-type-archive-links_metabox', plugins_url('/metabox.js', __FILE__), array('jquery'));
 
        //Add nonce variable
        wp_localize_script('mm-post-type-archive-links_metabox','mmPostTypeArchiveLinks', array('nonce'=>wp_create_nonce('mm-add-post-type-archive-links')));
    }
    ...
    public function ajax_add_post_type() {
        ...
        check_ajax_referer('mm-add-post-type-archive-links', 'posttypearchive_nonce');
...
mm_post_type_archive_link::load();
